...
@push('styles')
<style>
    .ai-container { max-width: 720px; margin: 0 auto; padding: 1.5rem 2rem 2rem; display: flex; flex-direction: column; height: calc(100vh - 60px); }
    .ai-header { text-align: center; margin-bottom: 1.25rem; flex-shrink: 0; }
    .ai-title { font-family: 'Playfair Display', serif; font-size: 1.4rem; font-weight: 600; color: var(--text); display: flex; align-items: center; justify-content: center; gap: .5rem; }
    .ai-subtitle { font-size: .75rem; color: var(--text-muted); display: flex; align-items: center; justify-content: center; gap: .4rem; margin-top: .2rem; }
    .ai-subtitle .dot { width: 6px; height: 6px; border-radius: 50%; background: #22c55e; display: inline-block; }
    .ai-messages { flex: 1; overflow-y: auto; padding: .5rem 0; display: flex; flex-direction: column; gap: .75rem; }
    ...
    .msg-row.assistant .msg-bubble { background: var(--surface2); color: var(--text); border-bottom-left-radius: 4px; }
    .typing { display: flex; gap: 4px; padding: .65rem 1rem; background: var(--surface2); border-radius: 18px; border-bottom-left-radius: 4px; width: fit-content; }
    ...
    .ai-input-wrap { flex-shrink: 0; padding-top: .75rem; border-top: 1px solid var(--border); margin-top: .5rem; }
    .ai-input-row { display: flex; align-items: center; gap: .5rem; background: var(--surface2); border: 1px solid var(--border); border-radius: 14px; padding: .3rem .3rem .3rem 1rem; }
    ...
    .ai-input-row button { width: 38px; height: 38px; border-radius: 10px; border: none; background: #6366f1; color: #fff; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: opacity .15s; flex-shrink: 0; }
